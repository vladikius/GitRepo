        ...
        <head>
            ...
            <link rel="shortcut icon">
                <xsl:attribute name="href">
                    ...
                    <xsl:text>/images/escudo.ico</xsl:text>
                </xsl:attribute>
            </link>
        ...
        <div id="ds-footer-wrapper">
            <div id="ds-footer">
                <div id="ds-footer-left">
                    <a href="http://www.dspace.org/" target="_blank">DSpace software</a> copyright&#160;&#169;&#160;2018&#160; <a href="http://www.duraspace.org/" target="_blank">DuraSpace</a>
                </div>
                <div id="ds-footer-right">
                    <span class="theme-by">Vicerrectorado de Investigación</span>
